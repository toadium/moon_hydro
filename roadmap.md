...
- [x] 全套文档完善（用户手册/API 文档/部署指南） ✅ V1.0
- [x] README 精美化（badge/架构图/性能基准） ✅ V1.0
...
- [x] mooncakes.io 包正式发布（待账号匹配后执行 moon publish） ✅ V1.0
...
| V0.9.2 | 415+ | 72 | ✅ |
| V0.9.3 | 415+ | 73 | ✅ |
| V0.8.1 | 151 | 7 | ✅ mooncakes.io |
| V1.0.0 | 415+ | 73 | ✅ |
| V1.0 | 415+ | 73 | ✅ |

---

*最后更新：2026-09-03｜当前版本：V0.8.1｜415+ 测试通过｜CI/CD 全绿｜GitHub Release v1.0.0 已触发*